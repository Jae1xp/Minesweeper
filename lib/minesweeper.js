...
var getNumberOfNeighborsBombs = function getNumberOfNeighborsBombs(bombBoard, rowIndex, columnIndex) {
...
var flipTile = function flipTile(playerBoard, bombBoard, rowIndex, columnIndex) {
		if (playerBoard[rowIndex][columnIndex] !== ' ') {
				...
				playerBoard[rowIndex][columnIndex] = getNumberOfNeighborsBombs(bombBoard, rowIndex, columnIndex);
		}
};
